...
{
    public class GetResultToCompeteEventListener : Java.Lang.Object, IEventListener
    {
        private Action<RankingEntry> callback;
        private string currentUserUID;

        public GetResultToCompeteEventListener(Action<RankingEntry> callback, string userUID)
        {
